jQuery(function($) {
	...
	$('#c1').on('click',function(){
		let i = $('#c1').hasClass('collapsed');
		if(i==true){
			$('#c1').find('i').eq(0).removeClass('mdi-chevron-down');
			$('#c1').find('i').eq(0).addClass('mdi-chevron-up');

			$('#c2').find('i').eq(0).removeClass('mdi-chevron-up');
			$('#c3').find('i').eq(0).removeClass('mdi-chevron-up');
			$('#c4').find('i').eq(0).removeClass('mdi-chevron-up');
			$('#c2').find('i').eq(0).addClass('mdi-chevron-down');
			$('#c3').find('i').eq(0).addClass('mdi-chevron-down');
			$('#c4').find('i').eq(0).addClass('mdi-chevron-down');

		}
		else{
			$('#c1').find('i').eq(0).removeClass('mdi-chevron-up');
			



			$('#c1').find('i').eq(0).addClass('mdi-chevron-down');
		}
	});
	$('#c2').on('click',function(){
		let i = $('#c2').hasClass('collapsed');
		if(i==true){
			$('#c2').find('i').eq(0).removeClass('mdi-chevron-down');
			...
			$('#c2').find('i').eq(0).addClass('mdi-chevron-up');
		}
		else{
			$('#c2').find('i').eq(0).removeClass('mdi-chevron-up');
			$('#c2').find('i').eq(0).addClass('mdi-chevron-down');
	...
	$('#c3').on('click',function(){
		let i = $('#c3').hasClass('collapsed');
		if(i==true){
			$('#c3').find('i').eq(0).removeClass('mdi-chevron-down');
			...
			$('#c3').find('i').eq(0).addClass('mdi-chevron-up');
		}
		else{
			$('#c3').find('i').eq(0).removeClass('mdi-chevron-up');
			$('#c3').find('i').eq(0).addClass('mdi-chevron-down');
	...
	$('#c4').on('click',function(){
		let i = $('#c4').hasClass('collapsed');
		if(i==true){
			$('#c4').find('i').eq(0).removeClass('mdi-chevron-down');
			...
			$('#c4').find('i').eq(0).addClass('mdi-chevron-up');
		}
		else{
			$('#c4').find('i').eq(0).removeClass('mdi-chevron-up');
			$('#c4').find('i').eq(0).addClass('mdi-chevron-down');
